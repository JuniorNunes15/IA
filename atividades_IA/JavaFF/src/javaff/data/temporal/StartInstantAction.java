...
public class StartInstantAction extends SplitInstantAction {
	...
	public boolean exclusivelyInvariant(Proposition p) {
		return !parent.startCondition.getConditionalPropositions().contains(p)
				|| !parent.startEffect.getAddPropositions().contains(p)
				|| !parent.startEffect.getDeletePropositions().contains(p);
	}
}
