...
public interface PDDL21parserConstants {
	...
	String[] tokenImage = { "<EOF>", "\" \"", "\"\\r\"", "\"\\t\"", "\"\\n\"", "\"(\"", "\")\"", "\"define\"",
			...
			"\"and\"", "\"not\"", "\"over all\"", "\"at start\"", "\"at end\"", "\"=\"", "\"-\"", "<BINARY_OP>",
			"<BINARY_COMP>", "<ASSIGN_OP>", "\"assign\"", "\"scale-up\"", "\"scale-down\"", "\"increase\"",
			"\"decrease\"", "<OPTIMIZATION>", "\"minimize\"", "\"maximize\"", "\"total-time\"", "<VAR>", "<NUMBER>",
