...
public class TemporalMetricState extends MetricState {
	...
	protected TemporalMetricState(Set a, Set f, GroundCondition g, Map funcs, TotalOrderPlan p, Metric m, Set oAc,
			List i) {
	...
	public boolean checkAvailability(Action a) {
		...
		if (!rList.isEmpty())
			return false;
		SchedulabilityChecker c = (VelosoSchedulabilityChecker) checker.clone(); // This should have to be cloned here
																					// and below
