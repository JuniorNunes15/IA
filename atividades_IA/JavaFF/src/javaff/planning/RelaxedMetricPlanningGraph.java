...
public class RelaxedMetricPlanningGraph extends RelaxedPlanningGraph {
	...
	private void updateResourceValues(int layer) {
		...
		// loop throught the current resource operators and if they increase/decrease
		// update the values on the new layer
	...
	public List searchRelaxedPlan(Set goalSet, Set mgoalSet, int l) {
		...
		// loop through the metric goals and see if they are satisfied, if not find some
		// actions
